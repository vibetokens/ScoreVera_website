...
notionId: ""
faq:
  - q: "What's the statute of limitations on credit card debt in Missouri?"
    a: "Missouri applies a five-year statute of limitations to credit card debt under its contract rules (RSMo § 516.120). Written promissory notes can carry a ten-year SOL."
  - q: "Does Missouri have state consumer protections beyond federal law?"
    a: "Yes. The Missouri Merchandising Practices Act (MMPA, RSMo § 407.010 et seq.) prohibits deceptive practices in trade and gives consumers a private right of action, including for deceptive debt collection conduct."
  - q: "How long do negative items stay on a Missouri credit report?"
