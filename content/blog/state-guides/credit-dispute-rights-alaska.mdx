...
notionId: ""
faq:
  - q: "What's the statute of limitations on credit card debt in Alaska?"
    a: "Alaska has a three-year statute of limitations on credit card debt and most open-account consumer debt, which is one of the shorter windows in the country. Written contracts can run longer, so verify the debt type before assuming the clock has run."
  - q: "Does Alaska have its own version of the federal FDCPA?"
    a: "Alaska does not have a comprehensive state debt collection statute, so residents rely primarily on the federal FDCPA and FCRA. The Alaska Unfair Trade Practices and Consumer Protection Act can still cover deceptive collector conduct."
  - q: "How long do collections stay on an Alaska credit report?"
    a: "Federal FCRA rules apply: most collections, charge-offs, and late payments must drop off after seven years, and Chapter 7 bankruptcies after ten years."
---
