...
notionId: ""
faq:
  - q: "What sections are on a credit report?"
    a: "Every credit report contains five main sections: personal information, account information (trade lines), collections, public records (bankruptcies, judgments), and inquiries. All three bureaus follow the same structure, though the layout and terminology varies slightly."
  - q: "What's a trade line on a credit report?"
    a: "A trade line is an entry for each credit account — credit cards, loans, mortgages — showing the creditor, account number, balance, payment status, and a month-by-month payment history grid. This section has the largest impact on your credit score."
  - q: "What should I look for when reviewing my credit report?"
    a: "Check every account for incorrect balances, wrong payment status (late when you paid on time), accounts you don't recognize, incorrect credit limits, and duplicate entries for the same debt."
  - q: "Do all three credit reports look the same?"
    a: "They follow the same basic structure but the exact layout differs. More importantly, the data can differ — creditors don't always report to all three bureaus, so an account appearing on one report may not appear on another."
---
