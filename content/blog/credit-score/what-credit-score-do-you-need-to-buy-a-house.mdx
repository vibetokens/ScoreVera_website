...
notionId: ""
faq:
  - q: "What is the minimum credit score to buy a house?"
    a: "It depends on the loan type. Conventional loans require a minimum of 620. FHA loans allow as low as 580 with 3.5% down, or 500–579 with 10% down. VA loans don't have a VA-set minimum, but most lenders require at least 620."
  - q: "What credit score gets you the best mortgage rate?"
    a: "740 or above is where most lenders offer their best pricing. The gap between 740 and 800 in actual loan pricing is small, but the gap between 680 and 740 can translate to significantly higher rates and tens of thousands in extra interest over 30 years."
  - q: "Which credit score does a mortgage lender actually use?"
    a: "Mortgage lenders pull all three bureaus and use the middle score for qualification. If there are two borrowers, they use the lower of the two middle scores. This makes it important to check all three reports before applying."
  - q: "What's the difference between FHA and conventional mortgage requirements?"
    a: "FHA loans allow lower scores (580 minimum with 3.5% down) but require mortgage insurance premiums for the life of the loan. Conventional loans require 620+ but let you cancel PMI once you reach 20% equity."
---
