...
faq:
  - q: "How many points does a hard inquiry take off your credit score?"
    a: "A single hard inquiry typically costs 5–10 points. The impact peaks immediately and fades over about 12 months, even though the inquiry stays visible on your report for 24 months."
  - q: "Can an employer checking my credit hurt my score?"
    a: "No — employer background checks are soft inquiries, which never affect your score. You do need to authorize them in writing, but they carry zero scoring impact."
  - q: "How do I dispute an unauthorized hard inquiry?"
    a: "Pull your report from AnnualCreditReport.com, identify the inquiry, and file a dispute with the bureau where it appears. State that you did not authorize the inquiry and did not apply for credit with that company. If the creditor can't verify authorization, the inquiry must be removed."
  - q: "Does rate-shopping for a mortgage count as multiple hard inquiries?"
    a: "No — multiple mortgage or auto loan inquiries within 45 days (under FICO 8) are treated as a single inquiry. This protection applies to mortgage, auto, and student loans only, not credit card applications."
---
