...
Each negative account entry weighs down your credit score separately. A single charged-off debt is bad enough; having it appear twice means two negative marks affecting your payment history and your number of derogatory accounts. Removing a true duplicate can produce a meaningful score increase, especially if the duplicate is a collection account with a balance.
