...
notionId: ""
faq:
  - q: "Why does the same debt appear twice on my credit report?"
    a: "This typically happens when debt is sold — the original creditor's charge-off and the new collection agency's account can both appear. It's permissible if accurate, but if both show the same outstanding balance, it creates misleading double-counting."
  - q: "Is it legal for a charge-off and a collection account to both show on my report?"
    a: "Yes, under the FCRA both can appear as long as the entries are accurate and clearly linked. The original creditor's entry should show $0 or 'transferred/sold,' and the collection entry should show the actual balance being collected."
  - q: "How do I dispute a duplicate account on my credit report?"
    a: "File a dispute identifying both entries by creditor name, account number, and balance, explaining that they represent the same underlying debt. Send simultaneous disputes to both furnishers under FCRA § 623."
  - q: "Can a debt appear three or four times on my report?"
    a: "Yes — if a debt is sold from one collector to another to another, each may report a tradeline. Only the current owner should be actively reporting the collection; prior owners should show their entries as closed or transferred."
---
