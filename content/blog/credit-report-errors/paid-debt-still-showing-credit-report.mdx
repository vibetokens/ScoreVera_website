...
notionId: ""
faq:
  - q: "I paid off a debt but it still shows as unpaid on my credit report — why?"
    a: "Furnishers report on monthly cycles, so there's always some lag. But if the paid status hasn't updated weeks or months later, the furnisher has failed to report the update — file a dispute with documentation of your payment."
  - q: "Does paying a collection remove it from my credit report?"
    a: "No — paying updates the collection to show $0 and 'paid,' but the collection entry itself can remain for seven years from the original date of first delinquency. Only a pay-for-delete agreement or a successful goodwill request can remove it early."
  - q: "What is a pay-for-delete agreement?"
    a: "A pay-for-delete is a written agreement where the collector agrees to remove the tradeline entirely from all three bureaus in exchange for payment. Not all collectors will agree to this, and you must get it in writing before paying."
  - q: "What documentation do I need to dispute a paid debt that's still showing?"
    a: "Gather your payoff confirmation letter, bank records showing the payment cleared, or a settlement agreement showing the account was resolved. File a written dispute with this documentation attached."
---
...
**Step 3: Dispute if no update appears.** If the account still shows the old balance or delinquency status after one billing cycle, [file a dispute with the credit bureau](/blog/how-to-dispute-credit-report-error). Attach your proof of payment and explain what the correct status should be.
