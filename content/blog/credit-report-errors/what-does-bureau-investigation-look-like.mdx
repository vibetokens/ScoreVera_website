...
notionId: ""
faq:
  - q: "Does anyone actually read my dispute letter at the credit bureau?"
    a: "Usually not. The bureau converts your dispute into a two- or three-digit E-OSCAR code and transmits it electronically to the furnisher. The furnisher's system often responds without human review of your actual letter or documentation."
  - q: "What is E-OSCAR and why does it matter for my dispute?"
    a: "E-OSCAR is the automated system all three major bureaus use to process disputes. Your detailed letter is reduced to a standard code before it reaches the furnisher — which is why specific, evidence-backed disputes are harder to dismiss than vague complaints."
  - q: "Have courts said the E-OSCAR process is sufficient for a 'reasonable reinvestigation'?"
    a: "Multiple federal courts have found that an E-OSCAR response alone may not constitute a 'reasonable reinvestigation' under FCRA § 611 when the consumer has provided specific evidence of inaccuracy."
  - q: "What should I do if my first dispute is denied?"
    a: "Treat the first dispute as an opening move. Request the method of verification, file a CFPB complaint, and dispute directly with the furnisher — who must conduct an independent investigation separate from the bureau's E-OSCAR process."
---
