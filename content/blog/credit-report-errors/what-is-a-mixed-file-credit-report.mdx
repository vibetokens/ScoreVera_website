...
notionId: ""
faq:
  - q: "How does a mixed credit file happen?"
    a: "Bureaus match incoming data using identifiers like name, SSN, address, and date of birth. When two consumers have similar information — same name, a transposed SSN digit, or shared address history — the bureau's algorithm may merge their files."
  - q: "What are the signs that my credit report has a mixed file?"
    a: "Watch for: accounts you've never heard of, addresses in places you've never lived, employers you've never worked for, or hard inquiries from companies you've never applied to."
  - q: "Can a mixed file actually increase my credit score?"
    a: "Temporarily, yes — if the other person has positive accounts, they might inflate your score. But the mix will eventually be discovered and corrected, which could cause a sudden score drop. Either way, the data is wrong and needs to be fixed."
  - q: "How do I fix a mixed credit file?"
    a: "Send a written dispute to the bureau explicitly requesting a file separation — not just individual account deletions. Include strong identity documentation and a complete list of every account that doesn't belong to you. Contact each bureau separately."
---
