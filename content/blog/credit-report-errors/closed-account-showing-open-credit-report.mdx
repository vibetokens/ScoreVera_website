...
notionId: ""
faq:
  - q: "Why is my closed credit card still showing as open on my report?"
    a: "Creditors report on a monthly cycle, so there can be a lag after closure. If the account is still showing open weeks or months later, the creditor has failed to update their reporting — file a dispute with supporting documentation of the closure."
  - q: "Does a closed account hurt my credit score?"
    a: "A closed account with no balance doesn't directly hurt your score, but if it incorrectly shows a balance it can inflate your utilization ratio and lower your score."
  - q: "What's the difference between 'closed by consumer' and 'closed by creditor' on a credit report?"
    a: "'Closed by consumer' means you requested the closure, which is neutral to positive. 'Closed by creditor' suggests the lender cut off the account, often due to missed payments — if you closed it voluntarily but it says 'closed by creditor,' that's an error worth disputing."
  - q: "How do I dispute an account that should show as closed?"
    a: "Gather confirmation of the closure (email, letter, or screenshot), then file a dispute with each bureau where the error appears and attach the documentation showing the account was closed."
---
