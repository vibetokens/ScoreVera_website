...
faq:
  - q: "What is zombie debt?"
    a: "Zombie debt is old debt — often time-barred, already paid, settled, or past the 7-year reporting window — that collectors attempt to revive by re-reporting it or contacting you to collect again."
  - q: "Can a collector put an old debt back on my credit report after it's been removed?"
    a: "Not legally if the 7-year FCRA window has passed. Re-reporting an expired debt with a new date of first delinquency is a violation of FCRA § 605 and § 623. If this happens, dispute immediately and file a CFPB complaint."
  - q: "Should I make a small payment on an old debt a collector contacts me about?"
    a: "Be very careful. In many states, any payment on a time-barred debt restarts the statute of limitations clock, giving the collector the ability to sue you again. Get legal advice before making any payment on a debt you believe may be time-barred."
  - q: "How is zombie debt different from regular old debt on my credit report?"
    a: "Regular old negative items stay on your report for the standard 7-year window and then age off normally. Zombie debt is specifically the illegal re-reporting or re-aging of debt that should have been removed or never reappeared — it's a violation of the FCRA, not just normal reporting."
---
