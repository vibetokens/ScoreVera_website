...
notionId: ""
faq:
  - q: "My auto loan shows a balance even though I paid it off — what should I do?"
    a: "File a dispute with the bureaus reporting the balance, attaching your payoff confirmation or lien release. The account should show $0 and a status of 'closed/paid in full.'"
  - q: "What's the difference between a voluntary and involuntary repossession on a credit report?"
    a: "A voluntary repossession means you surrendered the vehicle; an involuntary means the lender seized it. Both are negative, but they should be labeled accurately — if you voluntarily surrendered the car but the report says 'repossession,' dispute the classification with documentation."
  - q: "Can a refinanced auto loan create credit report errors?"
    a: "Yes. When you refinance, the original loan should show as paid/closed and the new loan opens as a separate account. If both show active balances, that's a duplicate worth disputing."
  - q: "How long does a repossession stay on my credit report?"
    a: "A repossession stays for seven years from the date of first delinquency on the original account — not from the repossession date itself."
---
