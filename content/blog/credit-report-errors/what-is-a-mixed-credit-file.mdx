...
notionId: ""
faq:
  - q: "What is a mixed credit file?"
    a: "A mixed credit file — also called a merged or commingled file — happens when a credit bureau combines information from two different consumers into one report, meaning someone else's accounts, debts, and payment history appear on your credit report."
  - q: "Who is most likely to have a mixed credit file?"
    a: "People with common names, fathers and sons who share a name, relatives living at the same address, and anyone whose SSN has a one-digit similarity to another consumer's are at higher risk."
  - q: "How do I know if my credit file is mixed with someone else's?"
    a: "Look for accounts from states you've never lived in, employers you've never worked for, a credit history that seems to predate your age, or accounts opened under name variations you've never used."
  - q: "Is a mixed credit file the bureau's fault?"
    a: "Yes. The FCRA requires bureaus to follow 'reasonable procedures to assure maximum possible accuracy.' A mixed file is a failure of that standard — the bureau is liable for it under FCRA § 611."
---
