...
notionId: ""
faq:
  - q: "Are tax liens still allowed on credit reports?"
    a: "No. All three major bureaus stopped reporting tax liens in 2017 under the National Consumer Assistance Plan. If a tax lien is appearing on your report today, it shouldn't be there."
  - q: "Why would a tax lien still show up on my credit report after 2017?"
    a: "It could be a data system error where old records resurfaced, a mixed file issue, incorrect coding, or a civil judgment being confused for a tax lien. Pull your report from AnnualCreditReport.com to determine what type of record is listed."
  - q: "Is a civil judgment the same as a tax lien on a credit report?"
    a: "No, they are different records. Tax liens are no longer reported by the three major bureaus. Civil judgments have also been reduced under NCAP standards but may still appear in some cases — the record type is important to verify before disputing."
  - q: "How do I dispute a tax lien that's still appearing on my credit report?"
    a: "File a dispute directly with the bureau citing the 2017 NCAP changes, include documentation from the IRS or state showing the lien's status, and request removal as the item should not be reportable."
---
