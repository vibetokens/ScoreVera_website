...
notionId: ""
faq:
  - q: "My student loans show late payments during the COVID forbearance period — is that an error?"
    a: "Yes. Federal student loans were placed in administrative forbearance from March 2020 through the end of the pause — no payments were due and none should have been reported as late during that period. Any delinquency during that window is a reportable error."
  - q: "What happens to my credit report when my student loans transfer to a new servicer?"
    a: "The old servicer should update their tradeline to show transferred or closed, and the new servicer opens a new tradeline. Errors are common at transfer — including duplicate accounts, missing payment history, and false delinquencies."
  - q: "Can I dispute student loan errors directly with the servicer?"
    a: "Yes. Dispute with each bureau reporting the error and simultaneously send a dispute to the loan servicer under FCRA § 623. For federal loans, attach records from StudentAid.gov as supporting documentation."
  - q: "How should a Direct Consolidation Loan appear on my credit report?"
    a: "The original individual loans should be updated to show paid/transferred and closed. The new consolidation loan appears as a new account. If old loans still show active balances alongside the consolidation loan, that's a dispute-worthy error."
---
