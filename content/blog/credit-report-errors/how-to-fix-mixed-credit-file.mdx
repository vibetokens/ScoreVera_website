...
notionId: ""
faq:
  - q: "What's different about disputing a mixed credit file vs. a regular error?"
    a: "A mixed file requires requesting a file separation — not just deleting individual accounts. Your letter must explicitly state that accounts belonging to another consumer have been merged into your file and request that the bureau split the files."
  - q: "What documentation do I need for a mixed file dispute?"
    a: "Bureaus require strong identity proof for file separations: a government-issued photo ID, your Social Security card, two forms of address verification, and your date of birth documentation."
  - q: "Do I need to contact all three bureaus for a mixed file?"
    a: "Yes. Each bureau must be contacted independently via Certified Mail with Return Receipt — a correction at one bureau does not carry over to the others."
  - q: "What should I do if the other person's accounts reappear after a file separation?"
    a: "Monitor your report for 90–120 days. If the accounts reappear, the bureau may have re-merged the files — escalate with a CFPB complaint and consider consulting an FCRA attorney."
---
