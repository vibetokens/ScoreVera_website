...
notionId: ""
faq:
  - q: "What is a debt validation letter and when do I need to send one?"
    a: "A debt validation letter is a written request under FDCPA § 1692g demanding the collector prove the debt is valid. Send it within 30 days of the collector's first contact — they must cease collection activity until they respond."
  - q: "What does 'time-barred' debt mean?"
    a: "A time-barred debt is one where the statute of limitations on suing you has expired. The collector can still ask you to pay, but they cannot legally sue you to force payment — and threatening legal action on a time-barred debt violates the FDCPA."
  - q: "Can I sue a collection agency for FDCPA violations?"
    a: "Yes. FDCPA violations entitle you to statutory damages of up to $1,000 per lawsuit, plus actual damages and attorney's fees. File complaints with the CFPB and your state attorney general as well."
  - q: "What happens if a collection agency inaccurately reports a debt on my credit report?"
    a: "File a formal dispute with the bureaus under FCRA § 611 and directly with the collector under § 623. If the collector cannot verify the exact details, the item must be removed."
---
