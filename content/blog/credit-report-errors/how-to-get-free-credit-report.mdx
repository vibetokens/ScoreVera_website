...
This means you have no excuse not to check your reports regularly. A quarterly review — one bureau roughly every four months, rotating between the three — is a practical schedule for most people. Keep in mind that [your three reports can differ significantly](/blog/equifax-experian-transunion-differences), so rotating through all three is worth the effort.
...
4. **Check the inquiries section** for any [hard pulls you didn't authorize](/blog/how-to-remove-hard-inquiry-credit-report).
5. **Make a list of anything that looks wrong** and prepare to [dispute it with the bureau](/blog/how-to-dispute-credit-report-error).
