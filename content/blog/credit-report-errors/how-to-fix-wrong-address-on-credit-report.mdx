...
notionId: ""
faq:
  - q: "Does a wrong address on my credit report hurt my credit score?"
    a: "Addresses don't directly affect your credit score. But an unknown address warrants investigation — it can indicate a mixed credit file or identity theft, both of which do cause damage."
  - q: "Why is there an address on my credit report I've never lived at?"
    a: "It could be a data entry error from a credit application, a mixed file where your report was combined with someone else's, or identity theft where someone used your SSN with a different address to open accounts."
  - q: "How do I get a wrong address removed from my credit report?"
    a: "Write a dispute letter to each bureau requesting the incorrect address be removed. Include a government-issued ID and a utility bill or bank statement confirming your actual address."
  - q: "What should I check for if an unfamiliar address appears on my report?"
    a: "Check whether any accounts are associated with that address. If unfamiliar accounts appear linked to the unknown address, this may signal a mixed file requiring a more comprehensive dispute."
---
