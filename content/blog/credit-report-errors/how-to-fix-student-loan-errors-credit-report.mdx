...
notionId: ""
faq:
  - q: "Where can I find the official record of my federal student loans?"
    a: "Log into StudentAid.gov for a complete history of all your federal loans — original amounts, servicers, payment history, and current status. This is the authoritative source for what your credit report should reflect."
  - q: "My student loan shows as delinquent during a deferment period — what do I do?"
    a: "Dispute with each bureau reporting the error and send a simultaneous dispute to the servicer under FCRA § 623, attaching your deferment confirmation documentation as supporting evidence."
  - q: "Can COVID payment pause errors still appear on my credit report?"
    a: "Yes — if a servicer incorrectly reported missed payments during the federally mandated pause, those errors can still be on your report. Dispute directly, citing the CARES Act and federal payment suspension directives."
  - q: "What happens when student loans are recently transferred to a new servicer?"
    a: "Both servicers may temporarily report the same loan simultaneously. Dispute the duplicate with the bureau, noting the transfer — the old servicer's tradeline should be updated to show transferred/closed."
---
