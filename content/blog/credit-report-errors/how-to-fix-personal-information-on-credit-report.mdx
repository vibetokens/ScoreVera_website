...
notionId: ""
faq:
  - q: "Does wrong personal information on my credit report affect my score?"
    a: "Personal information errors don't directly affect your credit score, but a wrong Social Security number or date of birth can cause your file to be mixed with another consumer's — pulling their negative accounts into your report."
  - q: "How do I correct my name or address on a credit report?"
    a: "Write a letter to each bureau requesting the correction and include documentation: a government-issued photo ID showing your correct name and date of birth, your Social Security card, and a utility bill or bank statement confirming your address."
  - q: "Why do I need to contact all three bureaus separately to fix personal information?"
    a: "Each bureau maintains its own independent database. A correction at Equifax doesn't carry over to Experian or TransUnion — you must submit the same documentation to all three."
  - q: "If my SSN is wrong on my credit report, what should I check for?"
    a: "A wrong SSN can cause a mixed file — pull your full report and review all accounts to make sure no accounts belonging to someone else have been merged into your file."
---
