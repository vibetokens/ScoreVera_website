...
notionId: ""
faq:
  - q: "Why do duplicate accounts hurt my credit score?"
    a: "Each entry counts separately in scoring calculations. A single debt appearing twice means your score is penalized twice — as if you had two separate delinquent accounts when you only had one."
  - q: "How do I identify a duplicate account on my credit report?"
    a: "List all accounts and look for the same original creditor name, similar account numbers, similar balances, and similar open dates. Multiple collection entries with different collector names but the same original creditor are a strong sign of duplication."
  - q: "How do I dispute a duplicate account?"
    a: "Write a dispute letter to the bureau identifying both entries and explaining they represent the same underlying debt. Send simultaneous disputes to both the original creditor and the collection agency under FCRA § 623."
  - q: "What should happen to my credit report after a successful duplicate account dispute?"
    a: "One entry should be removed or clearly designated as a zero-balance historical entry. If both furnishers independently verify their entries, escalate to the CFPB noting the duplicative reporting of a single debt."
---
