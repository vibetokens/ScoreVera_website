...
notionId: ""
faq:
  - q: "Where do I get the full Equifax credit report, not just a summary?"
    a: "Pull your report from AnnualCreditReport.com and download it as a PDF — the summary view strips out details. You need the full document to see every account, every reporting date, and every data field."
  - q: "What does the payment history grid on an Equifax account entry show?"
    a: "It shows a month-by-month record of your payment status — typically for 24 months — indicating whether each month was paid on time, 30 days late, 60 days late, etc."
  - q: "What personal information errors should I look for on my Equifax report?"
    a: "Look for names you don't recognize, addresses where you've never lived, and employers not in your history. These can be innocent data errors or signs of a mixed file or identity theft."
  - q: "What is the inquiries section of an Equifax report?"
    a: "It lists everyone who has pulled your credit — hard inquiries from credit applications (which affect your score) and soft inquiries from monitoring or pre-approval checks (which don't)."
---
