...
faq:
  - q: "What's the difference between a credit report and a credit score?"
    a: "Your credit report is a detailed document of your credit history maintained by each bureau. Your credit score is a number calculated by applying a scoring formula to that data — it's generated on demand and not stored in the report itself."
  - q: "Why do I have different credit scores at different bureaus?"
    a: "Each bureau maintains a separate file, and not all creditors report to all three bureaus. Since the scoring model uses each bureau's data independently, different information produces different scores."
  - q: "How does fixing a credit report error affect my score?"
    a: "Removing or correcting inaccurate negative information directly improves the data your score is calculated from — so fixing errors can lead to an immediate score increase."
  - q: "What is the most important factor in a FICO score?"
    a: "Payment history — whether you pay on time — accounts for 35% of a FICO Score 8, making it the single largest factor."
---
