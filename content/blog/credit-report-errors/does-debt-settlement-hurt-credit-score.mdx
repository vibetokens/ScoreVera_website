...
notionId: ""
faq:
  - q: "How does debt settlement appear on a credit report?"
    a: "A settled account is typically marked 'settled,' 'settled for less than full balance,' or 'account paid in settlement.' This notation stays on your report and signals to lenders that the debt was not paid as originally agreed."
  - q: "Is settling a debt better or worse than a charge-off for my credit?"
    a: "Settlement is better than an unpaid charge-off — it signals resolution. But it's worse than paying in full, since the settlement notation itself is a negative mark."
  - q: "Can I dispute anything about how a debt settlement is reported?"
    a: "Yes, if the reporting is inaccurate. Common disputable errors include: the balance not updated to $0 after settlement, the wrong settlement date, or the account still showing delinquent months after the settlement was accepted."
  - q: "Does the credit score damage from settlement happen when I settle, or earlier?"
    a: "Most of the damage happens before you settle — the late payments and potential charge-off while you stopped paying create the score drop. The settlement notation itself adds little additional damage at that point."
---
