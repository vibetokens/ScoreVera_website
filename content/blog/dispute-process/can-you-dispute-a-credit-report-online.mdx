...
notionId: ""
faq:
  - q: "Is disputing a credit report online as effective as sending a letter by mail?"
    a: "Online disputes are legally valid and trigger the same 30-day investigation requirement, but they limit your ability to explain complex errors. For simple, clear-cut mistakes, online is faster. For complex disputes, a detailed mail dispute gives you more control."
  - q: "What's the main advantage of disputing by mail versus online?"
    a: "Mail disputes let you write in your own words with no character limits, create a certified paper trail with documented delivery, and include detailed supporting documentation — all of which are harder to replicate through an online portal."
  - q: "Should you ever dispute by phone?"
    a: "Phone disputes are the weakest option — they create almost no documentation and give you the least control over the process. Phone is generally only useful for following up on existing disputes, not initiating them."
  - q: "What types of errors are best suited for an online dispute?"
    a: "Simple, clear-cut errors work best online: wrong balance, wrong status, duplicate accounts, or accounts that aren't yours. If your dispute involves a nuanced timeline or complex documentation, mail is the better approach."
---
