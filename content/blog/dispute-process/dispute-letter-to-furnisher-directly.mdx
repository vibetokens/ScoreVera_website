...
notionId: ""
faq:
  - q: "What is a furnisher and why would I dispute with them instead of the credit bureau?"
    a: "A furnisher is the company that reported the information to the bureau — the original creditor, bank, or collection agency. Disputing directly with them under FCRA § 623 requires them to conduct a genuine investigation using their own account records, rather than the bureau summarizing your dispute into a short code."
  - q: "Can I dispute with both the furnisher and the bureau at the same time?"
    a: "Yes — there is no rule requiring you to choose one or the other. Sending simultaneous disputes to both is often the most effective approach, creating pressure from two directions and establishing a paper trail with both parties."
  - q: "When does it make more sense to dispute with the furnisher than the bureau?"
    a: "Go to the furnisher when the error is specific to one creditor's records, when the bureau has already investigated and returned 'verified,' or when you have detailed documentation that directly contradicts what the furnisher reported. Going to the source is most effective when you can prove the creditor made the mistake."
  - q: "What happens if the furnisher corrects an error after I dispute directly with them?"
    a: "If the furnisher updates or deletes inaccurate information they reported, they are required to notify the credit bureaus of the correction. The bureaus then update your file accordingly, so the fix flows to your credit report automatically."
---
