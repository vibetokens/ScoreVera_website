...
notionId: ""
faq:
  - q: "How long does a credit dispute typically take to resolve?"
    a: "The legal maximum is 30 days (or 45 if you submit additional information mid-investigation), but many disputes resolve faster — often within 10 to 21 days. The 30-day clock starts from when the bureau receives your dispute, not when you submitted it."
  - q: "What takes the most time during a credit dispute investigation?"
    a: "Most of the time is spent waiting for the furnisher (the creditor or collector) to investigate and respond to the bureau, which typically happens between days 7 and 21. The bureau can't close the investigation until the furnisher responds."
  - q: "Does filing online versus by mail affect how long a dispute takes?"
    a: "Yes — online disputes start the clock immediately on the filing date. Mail disputes add transit time before the clock starts, typically 3 to 5 business days. If your dispute is time-sensitive, online filing is faster."
  - q: "What happens on day 30 if I haven't heard back from the bureau?"
    a: "If the bureau has not sent you written notification of the results by the deadline, the disputed item must be deleted by law. Document your timeline carefully so you know exactly when the window has expired and can act accordingly."
---
