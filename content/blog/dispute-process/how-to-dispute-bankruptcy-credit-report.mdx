...
faq:
  - q: "How long does bankruptcy stay on your credit report?"
    a: "Chapter 7 bankruptcy stays for 10 years from the filing date. Chapter 13 bankruptcy stays for 7 years from the filing date. These timers start at filing, not at the discharge date."
  - q: "What should accounts included in a bankruptcy look like on my credit report after discharge?"
    a: "After a Chapter 7 discharge, each included account should show 'discharged in bankruptcy' or 'included in bankruptcy' with a $0 balance and closed status. Any account still showing an open balance or active collection status after discharge is a reportable error."
  - q: "What are the most common errors in bankruptcy reporting?"
    a: "Common errors include accounts showing a remaining balance after discharge, accounts appearing as active collections despite being included in the bankruptcy, duplicate reporting of the same discharged debt, and incorrect discharge or filing dates."
  - q: "How do I get documentation to dispute bankruptcy reporting errors?"
    a: "Obtain your bankruptcy discharge order from PACER.gov, which provides access to federal court records. The discharge order lists every account included — use it to go line by line against your credit reports and identify every account that isn't showing a $0 balance and discharged status."
---
