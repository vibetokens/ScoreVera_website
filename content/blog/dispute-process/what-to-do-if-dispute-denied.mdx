...
notionId: ""
faq:
  - q: "What does it mean when a credit dispute is 'denied' or 'verified'?"
    a: "A denial means the bureau completed its inquiry and the furnisher confirmed the information. It does not mean the information is actually accurate — it often means the furnisher sent back an automated confirmation without reviewing actual documents. You still have multiple escalation options."
  - q: "What's the first thing I should do after a credit dispute is denied?"
    a: "Within 15 days, send a Method of Verification request under FCRA § 611(a)(7), asking specifically what documents the bureau or furnisher reviewed, who was contacted, and what information was used to verify the disputed item. This often exposes whether a genuine investigation was conducted."
  - q: "Can I add a statement to my credit file if a dispute is denied?"
    a: "Yes — under FCRA § 611(b), if a dispute is denied you have the right to add a 100-word consumer statement to your file explaining your position on the disputed item. It doesn't remove the item, but it appears on your report when lenders view it."
  - q: "When should I consult an attorney after a denied credit dispute?"
    a: "If the item is inaccurate and you've documented a full dispute campaign — including a bureau dispute, furnisher dispute, and CFPB complaint — all without resolution, a consumer rights attorney can evaluate whether you have a viable claim under FCRA §§ 616 or 617. Many take these cases on contingency."
---
