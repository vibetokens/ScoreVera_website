...
notionId: ""
faq:
  - q: "What does a Discover charge-off mean and can it be removed from my credit report?"
    a: "A charge-off means Discover wrote off your balance as a loss after 180 days of non-payment. An accurately reported charge-off cannot be removed through dispute, but specific errors — wrong date of first delinquency, inflated balance, duplicate reporting, or an account that isn't yours — can be disputed and corrected."
  - q: "If Discover sold my debt to a collector, will both the original account and the collection appear on my report?"
    a: "Yes — both can appear, but only one should carry a balance. If both the original Discover charge-off and a collection account show a balance, that's duplicate reporting and a disputable error. The combined balances should not exceed the actual amount owed."
  - q: "Can I dispute a Discover charge-off directly with Discover?"
    a: "Yes — under FCRA § 623(a)(8), you can dispute directly with Discover. They must investigate, correct or remove inaccurate information, and notify the bureaus of any corrections. Send your dispute to their customer service address with full documentation of the specific error."
  - q: "What is 're-aging' on a Discover charge-off and how do I catch it?"
    a: "Re-aging is the illegal practice of resetting the date of first delinquency to make the item appear newer, extending its 7-year reporting window. Compare the date on your credit report against your own records of when you first missed a payment — any discrepancy is worth disputing."
---
