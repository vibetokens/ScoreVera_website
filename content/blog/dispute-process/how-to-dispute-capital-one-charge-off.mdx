...
notionId: ""
faq:
  - q: "What does it mean when Capital One charges off my account?"
    a: "A charge-off is an accounting designation meaning Capital One wrote off your balance as a loss after roughly 180 days of non-payment. The debt still exists and can still be collected — it's one of the most damaging entries a credit report can carry."
  - q: "Can I dispute a Capital One charge-off if it's legitimately mine?"
    a: "You can only dispute a charge-off if there's a factual inaccuracy in how it's reported — wrong balance, wrong date of first delinquency, already paid or settled, or not your account. An accurately reported charge-off you legitimately defaulted on cannot be removed through a dispute."
  - q: "Why does the date of first delinquency matter so much on a charge-off?"
    a: "The date of first delinquency starts the 7-year reporting window. If Capital One reports a date later than your actual first missed payment, the charge-off appears newer than it is and stays on your report longer than the law allows. This error is directly disputable."
  - q: "Should I dispute a Capital One charge-off directly with Capital One or through the credit bureaus?"
    a: "Both simultaneously. Dispute with each bureau reporting the account and also send a direct dispute to Capital One under FCRA § 623. Disputing both at once applies maximum pressure and prevents the bureau from simply rubber-stamping Capital One's verification."
---
