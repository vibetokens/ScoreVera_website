...
notionId: ""
faq:
  - q: "What are valid grounds for disputing a Chase collection on my credit report?"
    a: "Valid grounds include balance errors (amount reported doesn't match what you owe or paid), date errors (wrong date of first delinquency), status errors (account shows unpaid when you settled), and account not yours due to identity theft or a bureau file mix-up."
  - q: "Does Chase investigate disputes in-house or through a third party?"
    a: "Unlike third-party debt collectors, Chase is the original creditor and maintains its own account records, meaning they investigate disputes in-house. This can work in your favor — Chase has direct access to the underlying data to confirm or correct errors."
  - q: "Should I dispute a Chase collection with the credit bureau or directly with Chase?"
    a: "Both simultaneously. Dispute with the bureaus reporting the account and send a direct dispute to Chase under FCRA § 623. Going both routes at once creates maximum pressure and reduces the chance of a rubber-stamp verification."
  - q: "What information should I have ready before disputing a Chase collection?"
    a: "Pull your credit reports and document the account number, current reported balance, date of first delinquency, date opened and closed, payment history, and current status. Compare this against your own statements and any correspondence from Chase to identify exact discrepancies."
---
