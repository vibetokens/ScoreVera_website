...
notionId: ""
faq:
  - q: "What is a goodwill deletion letter and when should I use one?"
    a: "A goodwill deletion letter is a direct request to a creditor asking them to remove an accurate negative mark as a courtesy. It's most appropriate for isolated late payments on accounts you've otherwise managed well — not for charge-offs, collections, or patterns of delinquency."
  - q: "Who should I send a goodwill letter to — the credit bureau or the creditor?"
    a: "Send it to the original creditor, not the credit bureaus. The bureaus only report what creditors tell them. If the creditor agrees to delete, they contact the bureau and the item comes off. Disputing accurate information with the bureau won't produce a removal."
  - q: "Is a creditor required to honor a goodwill deletion request?"
    a: "No — the FCRA doesn't require creditors to remove accurate information. A goodwill deletion is entirely voluntary. However, creditors are allowed to request deletions of accurate tradelines, and many do honor these requests, especially from long-term customers with a strong overall history."
  - q: "What should a goodwill letter include to be effective?"
    a: "Reference your overall account history with the creditor, explain the specific circumstances that led to the late payment (medical emergency, job loss, billing error), acknowledge the payment was late, and politely ask for a one-time removal. Keep the tone professional and brief — make it easy for the reader to say yes."
---
